...
if (@$_SESSION["username"]) {
    ...
    $dataliatkomen = mysqli_fetch_array(mysqli_query($connection, "SELECT * FROM lihat WHERE user_lihat='$username' AND apa_lihat='komentar'"));

    mysqli_query($connection, "UPDATE login SET status='Online' WHERE username='$username'");
    
    $query2 = mysqli_query($connection, "SELECT * FROM login WHERE username='$username'");
